...
ActiveRecord::Schema.define(version: 2023_06_06_064207) do
  ...
  create_table "meal_records", force: :cascade do |t|
    ...
    t.integer "dinner_cost", default: 0, null: false
    t.string "snack_memo"
    t.integer "snack_cost", default: 0, null: false
    t.string "something_memo"
    t.integer "something_cost", default: 0, null: false
